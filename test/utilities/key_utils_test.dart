...
void main() {
  group('getSignature', () {
    test('should return the correct signature', () {
      String hashHex = sha256
          .convert(utf8.encode("Try not. Do or do not. There is no try."))
          .toString();
      String privateKey =
          "8299b123b5eea7032d6183d3bde46be37a9b39a12deee10945263af59d89b2cc";
      String publicKey =
      ...
      expect(
          verify(PublicKey.fromHex(ec, publicKey), hash,
              Signature.fromDERHex(signature)),
          true);
    });
  });
}
